...
UNIFI_SOFTWARE_URL="https://dl.ui.com/unifi/6.2.17/UniFi.unix.zip"

# The rc script associated with this branch or fork:
RC_SCRIPT_URL="https://raw.githubusercontent.com/aasseman/unifi-pfsense/master/rc.d/unifi.sh"
